...
const messages = {
  en: {
    ...
    deepseekAPIKeyLabel: 'API Key',
    deepseekAPIKeyPlaceholder: 'API key for deepseek',
    deepseekBasePathLabel: 'Forward domain',
    deepseekBasePathPlaceholder: 'Forward domain',
    deepseekTemperatureLabel: 'Temperature',
    deepseekMaxTokensLabel: 'Max tokens',
    deepseekModelSelectLabel: 'Model',
    deepseekModelSelectPlaceholder: 'Please select model',
    deepseekCustomModelLabel: 'Custom Model',
    deepseekCustomModelPlaceholder: 'Please input model',
    translate: 'Trans',
    summary: 'Sum',
    polish: 'Polish',
    grammar: 'Grammar',
  ...
  'zh-cn': {
    ...
    deepseekAPIKeyLabel: 'API 密钥',
    deepseekAPIKeyPlaceholder: '请输入API KEY',
    deepseekBasePathLabel: 'API接口地址',
    deepseekBasePathPlaceholder: 'API接口地址',
    deepseekTemperatureLabel: 'Temperature',
    deepseekMaxTokensLabel: 'Max tokens',
    deepseekModelSelectLabel: '模型',
    deepseekModelSelectPlaceholder: '请选择模型',
    deepseekCustomModelLabel: '自定义模型',
    deepseekCustomModelPlaceholder: '请输入模型名称',
    translate: '翻译',
    summary: '摘要',
    polish: '润色',
    grammar: '语法',
